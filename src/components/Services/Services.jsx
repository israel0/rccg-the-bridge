  ...
  const services = [
    {
      ...
      image: '/features/feature-image-1.png',
      locationIcon: '/icons/location-icon.svg',
      calendarIcon: '/icons/calendar-icon.svg',
    },
    {
      ...
      location: 'Lagos Airport Hotel, Ikeja, Lagos',
      image: '/features/feature-image-2.png',
      locationIcon: '/icons/location-icon-2.svg',
      calendarIcon: '/icons/calendar-icon-2.svg',
    },
    {
      ...
      location: 'Lagos Airport Hotel, Ikeja, Lagos',
      image: '/features/feature-image-3.png',
      locationIcon: '/icons/location-icon-3.svg',
      calendarIcon: '/icons/calendar-icon-3.svg',
    },
  ]
